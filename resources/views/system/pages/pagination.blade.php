...
<div class="page-card automator-pagination-wrapper" data-automator-pagination="true" data-delete-message-confirm="{!! e($deleteMessageConfirm) !!}">
  ...
  <div class="page-card-body">
        ...
        <div class="col-12 col-sm-auto">
          ...
          <form method="GET" class="row g-3 align-items-end automator-ajax-ignore">
                    ...
                    @foreach($search_fields as $field => $label)
                      ...
                      <div class="form-check mb-2">
                        ...
                        <label for="search_in_{{ $field }}" class="form-check-label small w-100">
                          ...
                          <input class="form-check-input" id="search_in_{{ $field }}" name="search_in[]" type="checkbox" value="{{ $field }}" {!! in_array($field, request('search_in', array_keys($search_fields))) ? 'checked' : '' !!} />
            ...
            <div class="col-12 col-sm-auto">
              ...
              <button type="submit" class="btn btn-light border d-inline-flex align-items-center justify-content-center gap-2 w-100">
            ...
            @if(request('search') || request('where') || request('sort') || request('direction'))
              ...
              <div class="col-12 col-sm-auto">
                ...
                <a href="{!! request()->url() !!}" class="btn btn-outline-danger d-inline-flex align-items-center justify-content-center gap-2 w-100">
    ...
    @if( (count($header_actions) >= 1) || ($canDelete == true) )
    ...
    <div class="row g-0 automator-pagination-table-row">
      ...
      @endif
       ...
       @if($canDelete)
        ...
        <form method="POST" class="col-12 automator-pagination-table-column automator-pagination-delete-form" onsubmit="return false;">
      ...
      @else
        ...
        <div class="col-12 automator-pagination-table-column">
                    ...
                    <th scope="col" class="fw-semibold text-nowrap {!! $headerClasses !!}">
                      ...
                      @if($config['sortable'] ?? false)
                        ...
                        @else
                          ...
                          <a class="p-1 link-secondary" style="text-decoration: none !important;" href="{!! request()->fullUrlWithQuery(['sort' => $col, 'direction' => 'asc', 'page' => null]) !!}">
                        ...
                        @if($isSorted && request('direction') == 'desc')
                          ...
                          <a class="p-1" style="color: #0a58ca; text-decoration: none !important;">
                            ...
                            <i class="fa fa-sort-up" style="position: relative; top: 5px;"></i>

                          </a>

                        @else

                          <a class="p-1 link-secondary" style="text-decoration: none !important;" href="{!! request()->fullUrlWithQuery(['sort' => $col, 'direction' => 'desc', 'page' => null]) !!}">
    ...
    @if(
      ...
      <div class="row g-0 mt-4 automator-pagination-links-row">
