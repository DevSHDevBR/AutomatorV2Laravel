      ...
      $rotas = [
        ...
        // POST - START
          ...
          [
            ...
            'tbl_sys_route_method'     => 'storeData',
            'tbl_sys_route_args'       => '',
            'tbl_sys_route_content'    => '[automator function="store-data" table="tbl_posts" model="Post" form="admin-posts" with="GetPostUserTypes:ids,GetPostCategories:ids" module="Posts"]',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'tbl_sys_route_parent_id'  => 'admin-posts',
            'user_types'               => [1, 2]
          ...
          [
            ...
            'tbl_sys_route_method'     => 'updateData',
            'tbl_sys_route_args'       => '',
            'tbl_sys_route_content'    => '[automator function="update-data" table="tbl_posts" model="Post" index="tbl_post_ID" with="GetPostUserTypes:ids,GetPostCategories:ids" module="Posts"]',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'tbl_sys_route_parent_id'  => 'admin-posts',
            'user_types'               => [1, 2]
