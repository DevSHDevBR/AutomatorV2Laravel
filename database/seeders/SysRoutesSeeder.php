      ...
      $rotas = [
        ...
        // NOTIFICAÇÕES - START
          ...
          [
            ...
            'tbl_sys_route_args'       => '{id?}',
            'tbl_sys_route_content'    => '<code>[automator function="get-data" table="tbl_sys_notifications" index="tbl_sys_notification_ID"]</code>',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'user_types'               => [1, 2, 3, 4]
          ...
          [
            ...
            'tbl_sys_route_args'       => '{id?}',
            'tbl_sys_route_content'    => '<code>[automator function="update-data" table="tbl_sys_notifications" index="tbl_sys_notification_ID"]</code>',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'user_types'               => [1, 2, 3, 4]
        ...
        // GALERIA => TIPOS DE MIDIA - START
          ...
          [
            ...
            'tbl_sys_route_args'       => '',
            'tbl_sys_route_content'    => '<code>[automator function="store-data" table="tbl_sys_uploads_types" form="admin-midia-types"]</code>',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'tbl_sys_route_parent_id'  => 'admin-galeria',
            'user_types'               => [1, 2]
        ...
        // TIPOS DE USUARIOS - START
          ...
          [
            ...
            'tbl_sys_route_method'     => 'storeData',
            'tbl_sys_route_args'       => '',
            'tbl_sys_route_content'    => '<code>[automator function="store-data" table="tbl_users_types" form="admin-users-types"]</code>',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'tbl_sys_route_parent_id'  => 'admin-usuarios',
            'user_types'               => [1, 2]
        ...
        // AUTOMATOR => SHORTCODES - START
          ...
          [
            ...
            'tbl_sys_route_method'     => 'getFunction',
            'tbl_sys_route_args'       => '',
            'tbl_sys_route_content'    => '<code>[automator function="store-data" table="tbl_sys_shortcodes" form="admin-shortcodes"]</code>',
            'tbl_sys_route_area'       => 'restrict',
            'tbl_sys_route_status'     => 'ativo',
            'tbl_sys_route_parent_id'  => 'admin-automator',
            'user_types'               => [1]
